...
**Seção 1: Introdução** - 1h43m :white_check_mark:
...
**Seção 2: Configurando o Computador** - 46m  :white_check_mark:
...
**Seção 3: Iniciando com Programação** - 2h 16m  :white_check_mark:
...
**Seção 4: Operadores** - 3h 11m  :white_check_mark:
...
**Seção 5: Estruturas de Controle** - 3h 27m :white_check_mark:
...
**Seção 6: Funções** - 3h 20m :white_check_mark:
...
**Seção 7: Arrays** - 1h 26m :white_check_mark:
...
**Seção 8: Objetos** - 1h 37m :white_check_mark:
